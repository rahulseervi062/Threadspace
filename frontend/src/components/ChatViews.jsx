    ...
    <div className="content-card chat-window" style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 120px)" }}>
      ...
      <div style={{ marginTop: "auto", paddingTop: 12, position: "relative" }}>
        ...
        <div
          ...
          onDrop={(e) => {
            const mediaFile = Array.from(e.dataTransfer?.files || []).find((file) =>
        ...
        >
          <input ref={fileInputRef} type="file" accept=".gif,image/gif,image/*,video/*" style={{ display: "none" }} onChange={handleMediaSelect} />
