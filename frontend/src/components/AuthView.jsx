  ...
  return (
    <main className="page-shell" style={{ position: "relative" }}>
      <section className="login-panel">
        <div className="brand-chip">Pulse</div>
        ...
        <h1>{authMode === "login" ? "Open Your Pulse" : "Create Your Pulse"}</h1>
        <p className="subtitle">
          {authMode === "login"
            ? "Log in for stories, visual drops, private chats, and circles."
            : "Create an account to post, chat, follow creators, and build channels."}
        </p>
        {authMode === "login" ? (
