...
const API_BASE =
  import.meta.env.VITE_API_BASE || (import.meta.env.DEV ? "http://localhost:4001" : "");
    ...
    <main className="reddit-shell">
      <header className="site-header">
        ...
        <nav className="site-nav">
          ...
          <button className={view === "settings" ? "nav-link active" : "nav-link"} type="button" onClick={() => setView("settings")}>Settings</button>
        </nav>
            ...
            {memberSearch.trim() ? (
              <>
                <div className="search-results-block">
                  <div className="search-section-title">Members</div>
                  {membersLoading ? (
            ...
            <div className="content-card community-page">
              ...
              <div className="community-summary">
                <div className="community-summary-item">
                  <span className="community-summary-label">Title</span>
                  <strong>{selectedCommunity.title}</strong>
                </div>
                <div className="community-summary-item">
                ...
                <div className="community-summary-item">
                  <span className="community-summary-label">Current Space</span>
                  <strong>Community View</strong>
                </div>
              </div>
